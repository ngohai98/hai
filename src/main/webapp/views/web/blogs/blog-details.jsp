            ...
            <div class="col-lg-12">
                <div class="blog-details-inner">
                    <div class="blog-detail-title">
                        <h2>Founder of Iphone</h2>
<%--                        <p>travel <span>- May 19, 2019</span></p>--%>
                    </div>
                    <div class="blog-large-pic">
                        <img src="<c:url value="/template/web/img/blog/blogIP-detail.jpg"/>" alt="">
                    </div>
                    <div class="blog-detail-desc">
                        <p>Steve Jobs được sinh ra ở San Francisco,
                            California bởi cha mẹ ruột của anh là Joanne Schieble và John Jandali.
                            Do gia đình phản đối, cả hai người đều không có điều kiện nuôi con nên đành phải
                            đem đứa con nhỏ của mình nhờ người khác nuôi hộ. Steve được Paul và Clara Jobs nhận nuôi,
                            người mà ông luôn coi là cha mẹ thực sự của mình. Ông được ghi nhận là một trong những người tiên phong trong cuộc cách mạng vi máy tính và điện thoại di động thông minh, đóng góp không nhỏ vào sự thành công của Apple với các sản phẩm như iPhone, iPod, iPad, macbook.
                        </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-6">
                                <a href="#" class="prev-blog">
                                    <div class="pb-pic">
                                        ...
                                        <img src="<c:url value="/template/web/img/blog/prev-blog.png"/>" alt="">
                                    </div>
                                    <div class="pb-text">
                            ...
                            <div class="col-lg-5 offset-lg-2 col-md-6">
                                <a href="#" class="next-blog">
                                    <div class="nb-pic">
                                        <img src="<c:url value="/template/web/img/blog/next-blog.png"/>" alt="">
                    ...
                    <div class="posted-by">
                        <div class="pb-pic">
                            <img src="<c:url value="/template/web/img/blog/post-by.png"/>" alt="">
                        </div>
                        <div class="pb-text">
                            <a href="#">
                                <h5>Shane Lynch</h5>
