											...
											<tbody>
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td>${item.dt_Ten}</td>
														<td><img src="${item.dt_HinhAnh}" alt="" style="width: 80px; height: 100px" /></td>
<%--														<td>${item.dt_HinhAnh}</td>--%>
														<td>${item.dt_ThongTinChiTiet}</td>
														<td>${item.dt_GiaBan}</td>
														<td>${item.dt_SoLuong}</td>
														<td>${item.dt_MauSac}</td>
														<td>${item.dt_Size}</td>
<%--														<td>${item.dt_Tag}</td>--%>
														<td>${item.dt_TrangThai}</td>
														<td>${item.dt_NgayDang}</td>
